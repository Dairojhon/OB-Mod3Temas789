...
public class Main {
    ...
    static void seleccion()
    {
        ...
        System.out.println("Presiona 2 si deseas ver el metodo para recorrer y mostrar el arreglo bidimensional.");
        ...
        switch (select) {
            case 0 -> cadenaInvertida("hola mundo");
            case 1 -> arrayUni("Aquí vamos aprendiendo");
            case 2 -> arrayBidi();
            case 3 -> ejVector();
            case 4 ->
            ...
            case 8 -> copyFiles("D:\\OBejercicio.txt", "D:\\copia.txt");
            case 9 -> {
